  ...
  if (loading) {
    return <>
      <div className="flex-col gap-4 w-full h-screen flex items-center justify-center">
        <div role='status' className='flex justify-center flex-col px-6 py-6 bg-white shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-lg w-[90%] md:w-[60%] h-auto'>
          <div className=' w-full flex justify-between items-start animate-pulse'>
            <div className=" flex items-center gap-3">
              <div className="bg-gray-300 rounded-full w-12 h-12 mb-4"></div>
              <div className="block">
